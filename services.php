...
<div id="wrapper"><!-- not needed? up to you: http://camendesign.com/code/developpeurs_sans_frontieres -->
	...
	<section class="billboard sub services">	
        <div class="big">what we do.</div>
	</section>
	
    <section class="overview inner clearfix">
        <div class="inner-text">
<h2>Commericial Screen Printing for Both Textiles and Flatstock</h2>
<p>
...
<h2>Graphic Design, Illustration, Lettering</h2>
<p>            
